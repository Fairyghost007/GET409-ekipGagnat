# Fiche équipe — GET409-ekipGagnat

## Identité de l'équipe

| Élément | Valeur |
|---|---|
| Nom de l'équipe | ekipGagnat |
| Référence | GET409-ekipGagnat |
| Secteur | Éducation numérique |
| Défi principal | Aider les étudiants à identifier rapidement des ressources pédagogiques fiables et adaptées à leur programme |
...
**Problème :** Les étudiants passent beaucoup de temps à chercher des cours et des explications, sans être sûrs de la fiabilité ni de l’adéquation des ressources trouvées à leur programme.
...
|---|---|---|
| Création et configuration du dépôt GitHub | Birane Ndiaye | Fait |
